exports.birthdayExecute = function() {
    ...
    if(jamv.getMonth() == today.getMonth()+1  && jamv.getDate()+1 == today.getDate()){
        //!jam=4
        embed=birthdayData.birthday[4];
    }else if(motov.getMonth() == today.getMonth()+1  && motov.getDate()+1 == today.getDate()){
        //!moto=1
        embed=birthdayData.birthday[1];
    }else if(reiyuuv.getMonth() == today.getMonth()+1  && reiyuuv.getDate()+1 == today.getDate()){
        //!reiyuu=0
        embed=birthdayData.birthday[0];
    }else if(shamojiv.getMonth() == today.getMonth()+1  && shamojiv.getDate()+1 == today.getDate()){
        //!shamoji=2
        embed=birthdayData.birthday[2];
    }else if(tasunv.getMonth() == today.getMonth()+1  && tasunv.getDate()+1 == today.getDate()){
        //!tasun=3
        embed=birthdayData.birthday[3];
    }else if(machamiv.getMonth() == today.getMonth()+1 && machamiv.getDate()+1 == today.getDate()){
        //!machami=5
